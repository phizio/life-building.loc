...
//add(this, 'http://w3widgets.com/templates/neat/1.4.0-demo-46674361/js/dragstart.move drag.move', preventDefault);
// Prevent text selection and touch interface scrolling
//add(this, 'http://w3widgets.com/templates/neat/1.4.0-demo-46674361/js/mousedown.move', preventIgnoreTags);
// Tell movestart default handler that we've handled this
return J(this,"http://w3widgets.com/templates/neat/1.4.0-demo-46674361/js/movestart.move",u),!0}function F(){// Don't bind to the DOM. For speed.
...
J(this,"http://w3widgets.com/templates/neat/1.4.0-demo-46674361/js/movestart.move",a.noop)},teardown:function(){K(this,"http://w3widgets.com/templates/neat/1.4.0-demo-46674361/js/movestart.move",a.noop)}},a.event.special.moveend={setup:function(){// Bind a noop to movestart. Why? It's the movestart
// setup that decides whether other move events are fired.
J(this,"movestart.moveend",a.noop)},teardown:function(){K(this,"movestart.moveend",a.noop)}},J(document,"http://w3widgets.com/templates/neat/1.4.0-demo-46674361/js/mousedown.move",k),J(document,"http://w3widgets.com/templates/neat/1.4.0-demo-46674361/js/touchstart.move",o),// Make jQuery copy touch event properties over to the jQuery event
